...
namespace Thetis
{
    public partial class frmAbout : Form
    {
        ...
        public void InitVersions(string version, string build, string db_version, string dx_version, string radio_model, string firmware_version, string protocol, string supported_protocol, string wdsp_version, string channel_master_version, string cmASIO_version, string portAudio_version, string andromeda_version)
        {
            ...
            lstVersions.Items.Add("Thetis N4EAC Edition RC1");
            lstVersions.Items.Add("Custom Enhancements:");
            lstVersions.Items.Add("• Added FFT Max to legacy RX1 analog S-meter");
            lstVersions.Items.Add("• Added FFT Max to legacy RX2 analog S-meter");
            lstVersions.Items.Add("• Simplified HF band layout");
            lstVersions.Items.Add("• Removed unused band controls for HL2");
